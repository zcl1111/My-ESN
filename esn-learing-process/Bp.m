...
traininput=load('traininputsequence1.txt');
trainoutput=load('traininputsequence1.txt');
testinput=load('testinputsequence1.txt');
testoutput=load('testinputsequence1.txt');
